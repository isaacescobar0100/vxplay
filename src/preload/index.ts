...
const api = {
  ...
  productosEliminados: () => ipcRenderer.invoke('productos:eliminados'),
  productosRestaurar: (id: number) => ipcRenderer.invoke('productos:restaurar', id),
  productosLiberarSku: (id: number) => ipcRenderer.invoke('productos:liberarSku', id),
