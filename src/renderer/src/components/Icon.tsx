/**
 * Iconos SVG en linea (estilo Lucide/Feather). Sin dependencias externas
 * para cumplir la CSP de la app. Trazo con `currentColor`, hereda el color del texto.
 */
...
const paths: Record<IconName, JSX.Element> = {
  ...
  store: (
    <>
      <path d="M2 7l1.5-4h17L22 7M4 7v13a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V7" />
      <path d="M2 7h20M9 21v-6h6v6" />
    </>
  ),
